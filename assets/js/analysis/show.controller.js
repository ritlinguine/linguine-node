...
//  }
  ...
  function visualizeSplatComplexity() {
    ...
    table += '<tr style="border-bottom: 1px solid black;"><td style="color:darkgreen;"><a href="javascript:void(0);" title="The number of propositions (ideas) in the text divided by the number of words. For example, the sentence &quot;The tall man was running&quot; has two propositions: &quot;The man is tall&quot; and &quot;The man was running.&quot;" style="color: darkgreen !important;"><b>Idea Density:</b><a></td><td>&nbsp;&nbsp;</td><td align="right">' + parseFloat($scope.results[0]["idea_density"]).toFixed(3) + '</td><td></td></tr>';
